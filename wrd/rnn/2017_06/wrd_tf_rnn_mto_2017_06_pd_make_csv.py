...
col_names = ["p_sincheon_1","p_hongtong_1"]
...
with tf.Session() as sess:
    ...
    try:
        ...
        spamwriter.writerow(['Timestamp',col_names[0],col_names[1], col_name, col_name + '_pre'])
        ...
        for i in range(len(TS) - num_periods, 0, -1):
            ...
            spamwriter.writerow([str(df_data_time_val[len(TS) - i - f_horizon]),str(df_data_ori[0][len(TS) - i - f_horizon]),str(df_data_ori[1][len(TS) - i - f_horizon]), y_input[0], test_predict[0][0]])
