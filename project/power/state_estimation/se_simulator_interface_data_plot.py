...
index_minutes = pd.date_range('2017-11-30 00:00:00', '2018-06-30', freq='4H')
...
df_result['current_18538'] = df_result[df_result.loc[:, 'current_18538'].isnull()]['current_2409'] - 66
print('차이_18538 :', )

# plt.plot(df_result.loc['2017-12-23':'2017-12-28','current_18538'])
plt.plot(df_result['current_5576'])
plt.legend()
plt.show()
plt.close()
