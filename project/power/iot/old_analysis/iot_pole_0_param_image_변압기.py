...
limit_ylim = {'TEMP':[0, 55], 'HUMI':[-5, 105], 'PITCH':[-185, 185], 'ROLL':[-95, 95], 'AMBIENT':[-100, 32000], 'UV':[-2, 23], 'PRESS':[-10, 1110], 'BATTERY':[-5, 105], 'SHOCK':[-1, 2], 'USN':[-10, 290], 'NTC':[-25, 125], 'UVC':[-1, 6]}
