...
def sample_Z(batch_size, seq_length, latent_dim, use_time=False, use_noisy_time=False):
    ...
    if use_time:
        ...
        # 3 차원 데이터의 가장 아래면 데이터를 0에서 1/30 사이의 데이터로 수정
...
#            [ 0.5750815 ]]]
# labels: None
# sess: <tensorflow.python.client.session.Session object at 0x000002AD800FFE10>
# Z: Tensor("Placeholder:0", shape=(28, 30, 5), dtype=float32)
# X: Tensor("Placeholder_1:0", shape=(28, 30, 1), dtype=float32)
# CG: Tensor("Placeholder_2:0", shape=(28, 0), dtype=float32)
# CD: Tensor("Placeholder_3:0", shape=(28, 0), dtype=float32)
# CS: Tensor("Placeholder_4:0", shape=(28, 0), dtype=float32)
# D_loss: Tensor("add:0", shape=(28, 1), dtype=float32)
# G_loss: Tensor("Mean_2:0", shape=(28, 1), dtype=float32)
# D_solver: name: "GradientDescent"
# op: "NoOp"
# input: "^GradientDescent/update_discriminator/W_out_D/ApplyGradientDescent"
# input: "^GradientDescent/update_discriminator/b_out_D/ApplyGradientDescent"
# input: "^GradientDescent/update_discriminator/rnn/lstm_cell/kernel/ApplyGradientDescent"
# input: "^GradientDescent/update_discriminator/rnn/lstm_cell/bias/ApplyGradientDescent"
#
# G_solver: name: "Adam"
# op: "NoOp"
# input: "^Adam/update_generator/W_out_G/ApplyAdam"
# input: "^Adam/update_generator/b_out_G/ApplyAdam"
# input: "^Adam/update_generator/rnn/lstm_cell/weights/ApplyAdam"
# input: "^Adam/update_generator/rnn/lstm_cell/biases/ApplyAdam"
# input: "^Adam/Assign"
# input: "^Adam/Assign_1"
#
# batch_size: 28
...
# Tensor("Placeholder:0", shape=(28, 30, 5), dtype=float32) Tensor("Placeholder_1:0", shape=(28, 30, 1), dtype=float32) {'batch_size': 28, 'learn_scale': False, 'cond_dim': 0, 'hidden_units_g': 100, 'num_generated_features': 1, 'seq_length': 30} {'batch_size': 28, 'batch_mean': False, 'cond_dim': 0, 'hidden_units_d': 100, 'seq_length': 30} 1 False Tensor("Placeholder_2:0", shape=(28, 0), dtype=float32) Tensor("Placeholder_3:0", shape=(28, 0), dtype=float32) Tensor("Placeholder_4:0", shape=(28, 0), dtype=float32) False
...
# Tensor("add:0", shape=(28, 1), dtype=float32) Tensor("Mean_2:0", shape=(28, 1), dtype=float32) 0.1 28 8400 1e-05 1 1e-05 False
...
# Tensor("Placeholder:0", shape=(28, 30, 5), dtype=float32) 100 30 28 1 False None 0 None False
# Tensor("Placeholder:0", shape=(28, 30, 5), dtype=float32) 100 30 28 1 True None 0 Tensor("Placeholder_2:0", shape=(28, 0), dtype=float32) False
...
# Tensor("Placeholder_1:0", shape=(28, 30, 1), dtype=float32) 100 30 28 False 0 None False
# Tensor("generator/Reshape_1:0", shape=(28, 30, 1), dtype=float32) 100 30 28 True 0 None False
