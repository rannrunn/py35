...
variable_all = ['TIME_ID', 'POLE_ID', 'SENSOR_ID', 'PART_NAME', 'TEMP', 'HUMI', 'PITCH', 'ROLL','AMBIENT','PRESS', 'SHOCK', 'NTC', 'UVC']
variable_plot = ['TEMP', 'HUMI', 'PITCH', 'ROLL','AMBIENT','PRESS', 'SHOCK', 'NTC', 'UVC']
...
def main(path_dir, order, resample_how):
    ...
    df_pole_ntc = pd.read_csv('{}iot_pole_1st_param_ntc.csv'.format(path_dir), encoding = "euc-kr")
